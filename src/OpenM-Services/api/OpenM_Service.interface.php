...
interface OpenM_Service {
    const RETURN_ERROR_PARAMETER = "ERR";
    const RETURN_ERROR_CODE_PARAMETER = "ERRNO";
    const RETURN_VOID_PARAMETER = "VOID";
    const RETURN_ERROR_MESSAGE_PARAMETER = "ERRME";
    const RETURN_STATUS_PARAMETER = "ST";
    const RETURN_STATUS_OK_VALUE = "OK";
    const RETURN_ERROR_MESSAGE_ONLY_CALLABLE_BY_API_VALUE = "Restricted to API usage only";
    const RETURN_ERROR_CODE_ONLY_CALLABLE_BY_API_VALUE = -3;
